...
import { TPokemonImage, TPokemonType, translatePokemonTypeName } from '@/app/ui';
import { useMemo } from 'react';

type GalleryImageProps = Readonly<{
  types?: Array<TPokemonType  & { href: string }>;
  images?: TPokemonImage | null;
  pokemon_name: string;
  external_image?: string;
}>;
export default function PokemonGallery({ types, images, pokemon_name, external_image }: GalleryImageProps) {
