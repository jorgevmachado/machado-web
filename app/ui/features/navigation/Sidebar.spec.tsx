...
describe('Sidebar', () => {
  it('keeps Pokemon parent link navigable and expands children with arrow', () => {
    render(<Sidebar items={items} isCollapsed={false} pathname="/home" onLogout={jest.fn()} />);
  ...
  it('auto-expands Pokemon children for child routes', () => {
    render(<Sidebar items={items} isCollapsed={false} pathname="/pokemon/move/tackle" onLogout={jest.fn()} />);
