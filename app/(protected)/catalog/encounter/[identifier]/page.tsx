...
import { pokemonBffService ,TPokemonEncounter } from '@/app/ui';
...
import { DetailsPage } from '@/app/ui';
...
export default function MoveDetailPage() {
  ...
  const { data ,isLoading ,errorMessage } = useDetail<TPokemonEncounter>(
    { identifier ,fetchDetail: pokemonBffService.encounter.fetchOne });
